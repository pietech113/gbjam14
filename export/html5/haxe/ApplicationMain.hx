...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("gbjam14", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("gbjam14", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "gbjam14";
		app.meta["name"] = "gbjam14";
